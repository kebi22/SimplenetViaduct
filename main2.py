...
import os
import sys
#from datasets.viaduct import ViaductDataset, DatasetSplit
import click
import numpy as np
import torch
...
_DATASETS = {
    "viaduct": ["datasets.viadut", "ViaductDataset"],
}  
...
def dataset(
    ...
    def get_dataloaders(seed):
        ...
        for subdataset in subdatasets:
            # Passing dataset_name explicitly to fix the error
            train_dataset = dataset_library.__dict__[dataset_info[1]](
                data_path,
                dataset_name=subdataset,  # Fixed: passing 'dataset_name' explicitly
                resize=resize,
