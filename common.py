...
class NetworkFeatureAggregator(torch.nn.Module):
    ...
    def forward(self, images, eval=True):
      print(f"Input to backbone shape: {images.shape}")  # Debug
    ...
    def feature_dimensions(self, input_shape):
        ...
        print(f"Shape of _input for feature_dimensions: {_input.shape}")  # Debug
        _output = self(_input)
        print(f"Output shapes: {[self.outputs[layer].shape for layer in self.layers_to_extract_from]}")  # Debug
